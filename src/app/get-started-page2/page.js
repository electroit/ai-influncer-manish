              ...
              <div className="content-row h-100">
                <form className="d-flex flex-column justify-content-between h-100">
                  <div className="row form-conatent-section">
                    <div className="d-flex justify-content-between align-items-center pb-3 top-title-section">
                      <h2>Choose script from AI</h2>
                      <button className="btn btn-custom">
                        Use your own script
                      </button>
                    </div>
                    <div className="d-flex ai-script-select-row">
                      <label
                        htmlFor="select-scrip-1"
                        className="ai-script-select-single w-50 dark-card d-flex flex-column justify-content-center align-items-center mb-4"
                      >
                        <div className="card-top w-100 d-flex justify-content-between align-items-center pb-2">
                          <h3 className="m-0">Response Bubble</h3>
                          <label
                            htmlFor="edit-card-scrip-1"
                            className="edit-icon"
                          >
                            <img src="./assets/edit-icon.svg" height="20px" />
                            <input
                              type="checkbox"
                              id="edit-card-scrip-1"
                              className="edit-card-script d-none"
                            />
                          </label>
                        </div>
                        <div className="card-content">
                          <div className="card-content-text">
                            Awesome black shoee for all.
                            <br />
                            Oh, you're absolutely right about these Nike shoes!{" "}
                            <br />
                            They're not only stylish but incredibly comfortable
                            for everyday wear. Seriously, if you're looking for
                            versatility and comfort, these are a must-have. <br />
                            Grab a pair today, and feel the difference!
                          </div>
                          <div className="card-content-form">
                            <textarea
                              defaultValue={
                                "Awesome black shoee for all.Oh, you're absolutely right about these Nike shoes!  They're not only stylish but incredibly comfortable for everyday wear.Seriously, if you're looking for versatility and comfort, these are a must-have.Grab a pair today, and feel the difference!"
                              }
                            />
                          </div>
                        </div>
                      ...
                      <label
                        htmlFor="select-scrip-2"
                        className="ai-script-select-single w-50 dark-card d-flex flex-column justify-content-center align-items-center mb-4"
                      >
                        <div className="card-top w-100 d-flex justify-content-between align-items-center pb-2">
                          <h3 className="m-0">Response Bubble</h3>
                          <label
                            htmlFor="edit-card-scrip-2"
                            className="edit-icon"
                          >
                            <img src="./assets/edit-icon.svg" height="20px" />
                            <input
                              type="checkbox"
                              id="edit-card-scrip-2"
                              className="edit-card-script d-none"
                            />
                          </label>
                        </div>
                    ...
                    <div className="d-flex ai-script-select-row">
                      <label
                        htmlFor="select-scrip-3"
                        className="ai-script-select-single w-50 dark-card  d-flex flex-column justify-content-center align-items-center mb-4"
                      >
                        <div className="card-top w-100 d-flex justify-content-between align-items-center pb-2">
                          <h3 className="m-0">Response Bubble</h3>
                          <label
                            htmlFor="edit-card-scrip-3"
                            className="edit-icon"
                          >
                            <img src="./assets/edit-icon.svg" height="20px" />
                            <input
                              type="checkbox"
                              id="edit-card-scrip-3"
                              className="edit-card-script d-none"
                            />
                          </label>
                        </div>
                      ...
                      <label
                        htmlFor="select-scrip-4"
                        className="ai-script-select-single w-50 dark-card d-flex flex-column justify-content-center align-items-center mb-4"
                      >
                        <div className="card-top w-100 d-flex justify-content-between align-items-center pb-2">
                          <h3 className="m-0">Response Bubble</h3>
                          <label
                            htmlFor="edit-card-scrip-4"
                            className="edit-icon"
                          >
                            <img src="./assets/edit-icon.svg" height="20px" />
                            <input
                              type="checkbox"
                              id="edit-card-scrip-4"
                              className="edit-card-script d-none"
                            />
                          </label>
                        </div>
                  ...
                  <div className="form-action-section action d-flex align-items-center justify-content-end">
                    {/* Next Button */}
                    <a href="/get-started-page3" className="btn btn-custom">
                      Next
